...
import eu.kanade.tachiyomi.ui.browse.novel.source.NovelSourcesFilterScreenModel
...
@Composable
fun NovelSourcesFilterScreen(
    navigateUp: () -> Unit,
    state: NovelSourcesFilterScreenModel.State.Success,
