...
@Composable
fun NovelStatsScreenContent(
    state: StatsScreenState.SuccessNovel,
...
private fun LazyItemScope.OverviewSection(
    ...
    SectionCard(MR.strings.label_overview_section) {
        Row(
            ...
            StatsOverviewItem(
                title = data.libraryNovelCount.toString(),
            ...
            StatsOverviewItem(
                title = data.completedNovelCount.toString(),
...
private fun LazyItemScope.TitlesStats(
    ...
    SectionCard(MR.strings.label_titles_section) {
        Row {
            ...
            StatsItem(
                data.startedNovelCount.toString(),
                stringResource(MR.strings.label_started),
            )
            StatsItem(
                data.localNovelCount.toString(),
