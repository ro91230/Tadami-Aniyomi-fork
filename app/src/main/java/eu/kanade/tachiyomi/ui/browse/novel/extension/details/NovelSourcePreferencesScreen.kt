...
class NovelSourcePreferencesScreen(val sourceId: Long) : Screen() {
    ...
    override fun Content() {
        ...
        Scaffold(
            topBar = {
                AppBar(
                    title = Injekt.get<NovelSourceManager>().getOrStub(sourceId).toString(),
...
class NovelSourcePreferencesFragment : PreferenceFragmentCompat() {
    ...
    private fun populateScreen(): PreferenceScreen {
        ...
        if (source is ConfigurableNovelSource) {
    ...
    companion object {
        ...
        fun getInstance(sourceId: Long): NovelSourcePreferencesFragment {
            val fragment = NovelSourcePreferencesFragment()
